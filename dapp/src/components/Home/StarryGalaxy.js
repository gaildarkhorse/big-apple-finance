...
function run(container) {
  ...
  window.addEventListener('resize', function () {
    if ((typeof container !== 'undefined')) {
      container.width = w = window.innerWidth;
      container.height = h = window.innerHeight;
    }
  }, false);
}
...
const StarryGalaxy = () => {
  ...
  useEffect(() => {
    ...
    , [])
  return <canvas style={{ zIndex: -1, position: 'fixed', background: '#020410' }} ref={widget}></canvas>
}
